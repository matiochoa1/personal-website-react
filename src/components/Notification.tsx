...
export default function Notification() {
  ...
  return (
    <div
      aria-live="assertive"
      className="fixed inset-0 flex items-end px-4 py-4 pointer-events-none sm:items-start sm:p-6"
    >
      <div className="flex flex-col items-center w-full space-y-2 sm:items-end">
        <Transition
